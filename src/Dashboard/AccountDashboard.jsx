        ...
        <section className="lg:col-span-5 space-y-6">
          ...
          <div className="backdrop-blur-[40px] rounded-[2.5rem] p-8 bg-[#101916]/30 border border-white/5 shadow-inner">
            <div className="flex items-center justify-between mb-6 px-1">
              ...
              <button className="px-3 py-1 rounded-md text-[9px] font-black uppercase tracking-tighter text-[#101916] bg-[#AFC1B6] hover:bg-white active:scale-95 transition-all">
                + Add
              </button>
            </div>
