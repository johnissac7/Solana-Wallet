      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <button
              onClick={handleCopy}
              className="group relative w-full py-3.5 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] transition-all duration-500 overflow-hidden bg-[#AFC1B6] text-[#101916] shadow-[0_10px_25px_rgba(175,193,182,0.15)] active:scale-95"
            >
              <span className="relative z-10">
                {copied ? "Copied" : "Copy to Clipboard"}
              </span>

              {/* The Sliding Gloss Effect */}
